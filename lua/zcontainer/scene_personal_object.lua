...
local mergeDataFuncs = {
  [1] = function(container, buffer, watcherList)
    ...
    for i = 1, remove do
      ...
      container.personalObjData.__data__[dk] = nil
      container.Watcher:MarkMapDirty("personalObjData", dk, last)
    end
    for i = 1, update do
      local dk = br.ReadInt64(buffer)
      local last = container.personalObjData.__data__[dk]
      ...
      container.Watcher:MarkMapDirty("personalObjData", dk, {})
    end
  end
}
...
local resetData = function(container, pbData)
  ...
  if not pbData.personalObjData then
    container.__data__.personalObjData = {}
  end
...
local getContainerElem = function(container)
  ...
  local ret = {}
  if container.personalObjData ~= nil then
    local data = {}
    for key, repeatedItem in pairs(container.personalObjData) do
...
local new = function()
  ...
  setForbidenMt(ret)
  setForbidenMt(ret.personalObjData)
  return ret
end
return {New = new}
