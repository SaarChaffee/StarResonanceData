...
local mergeDataFuncs = {
  [1] = function(container, buffer, watcherList)
    local last = container.__data__.uploadCharId
    container.__data__.uploadCharId = br.ReadInt64(buffer)
    container.Watcher:MarkDirty("uploadCharId", last)
  end,
...
local resetData = function(container, pbData)
  ...
  if not pbData.uploadCharId then
    container.__data__.uploadCharId = 0
  end
