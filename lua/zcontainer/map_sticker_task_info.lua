...
local mergeDataFuncs = {
  [1] = function(container, buffer, watcherList)
    local last = container.__data__.taskId
    container.__data__.taskId = br.ReadUInt32(buffer)
    container.Watcher:MarkDirty("taskId", last)
  end,
...
local resetData = function(container, pbData)
  ...
  if not pbData.taskId then
    container.__data__.taskId = 0
  end
