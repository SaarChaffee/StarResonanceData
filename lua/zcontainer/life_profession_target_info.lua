...
local mergeDataFuncs = {
  ...
  [4] = function(container, buffer, watcherList)
    ...
    local t = {}
    local last = container.__data__.lifeTargetRewardStates
    container.__data__.lifeTargetRewardStates = t
    for i = 1, count do
      local v = br.ReadUInt32(buffer)
      t[#t + 1] = v
      container.Watcher:MarkDirty("lifeTargetRewardStates", last)
    end
  end
}
...
local resetData = function(container, pbData)
  ...
  if not pbData.lifeTargetRewardStates then
    container.__data__.lifeTargetRewardStates = {}
  end
...
local getContainerElem = function(container)
  ...
  if container.lifeTargetRewardStates ~= nil then
    local data = {}
    for index, repeatedItem in pairs(container.lifeTargetRewardStates) do
      data[index] = {
        fieldId = 0,
        dataType = 0,
        data = repeatedItem
