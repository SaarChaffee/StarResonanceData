...
local mergeDataFuncs = {
  [1] = function(container, buffer, watcherList)
    ...
    for i = 1, add do
      ...
      local v = require("zcontainer.shop_compensation_info").New()
    ...
    for i = 1, update do
      ...
      if last == nil then
        ...
        last = require("zcontainer.shop_compensation_info").New()
...
local resetData = function(container, pbData)
  ...
  for k, v in pairs(pbData.items) do
    container.items.__data__[k] = require("zcontainer.shop_compensation_info").New()
