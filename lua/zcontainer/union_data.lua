...
local mergeDataFuncs = {
  ...
  [3] = function(container, buffer, watcherList)
    local last = container.__data__.unionHuntRank
    container.__data__.unionHuntRank = br.ReadInt32(buffer)
    container.Watcher:MarkDirty("unionHuntRank", last)
  end
}
...
local resetData = function(container, pbData)
  ...
  if not pbData.unionHuntRank then
    container.__data__.unionHuntRank = 0
  end
