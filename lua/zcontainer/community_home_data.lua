...
local mergeDataFuncs = {
  ...
  [3] = function(container, buffer, watcherList)
    local last = container.__data__.fieldId
    container.__data__.fieldId = br.ReadInt32(buffer)
    container.Watcher:MarkDirty("fieldId", last)
  end
}
...
local resetData = function(container, pbData)
  ...
  if not pbData.fieldId then
    container.__data__.fieldId = 0
  end
