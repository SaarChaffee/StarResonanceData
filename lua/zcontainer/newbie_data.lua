...
local mergeDataFuncs = {
  [1] = function(container, buffer, watcherList)
    ...
    container.__data__.totalOnlineTime = br.ReadInt64(buffer)
  ...
  [3] = function(container, buffer, watcherList)
    local last = container.__data__.isCancelNewbie
    container.__data__.isCancelNewbie = br.ReadBoolean(buffer)
    container.Watcher:MarkDirty("isCancelNewbie", last)
  end
}
...
local resetData = function(container, pbData)
  ...
  if not pbData.isCancelNewbie then
    container.__data__.isCancelNewbie = false
  end
