...
local mergeDataFuncs = {
  [1] = function(container, buffer, watcherList)
    ...
    local t = {}
    local last = container.__data__.modParts
    container.__data__.modParts = t
    for i = 1, count do
...
local getContainerElem = function(container)
  ...
  local ret = {}
  if container.modParts ~= nil then
    local data = {}
    for index, repeatedItem in pairs(container.modParts) do
      data[index] = {
        fieldId = 0,
        dataType = 0,
        data = repeatedItem
