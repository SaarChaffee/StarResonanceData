...
local mergeDataFuncs = {
  [1] = function(container, buffer, watcherList)
    ...
    container.__data__.time = br.ReadUInt32(buffer)
  ...
  [3] = function(container, buffer, watcherList)
    local last = container.__data__.perfectTime
    container.__data__.perfectTime = br.ReadUInt32(buffer)
    container.Watcher:MarkDirty("perfectTime", last)
  end
}
...
local resetData = function(container, pbData)
  ...
  if not pbData.perfectTime then
    container.__data__.perfectTime = 0
  end
