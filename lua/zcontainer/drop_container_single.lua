...
local mergeDataFuncs = {
  ...
  [4] = function(container, buffer, watcherList)
    local last = container.__data__.HistoryCount
    container.__data__.HistoryCount = br.ReadInt32(buffer)
    container.Watcher:MarkDirty("HistoryCount", last)
  end
}
...
local resetData = function(container, pbData)
  ...
  if not pbData.HistoryCount then
    container.__data__.HistoryCount = 0
  end
