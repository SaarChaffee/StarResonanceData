...
local Season_achievement_detail_windowView = class("Season_achievement_detail_windowView", super)
...
function Season_achievement_detail_windowView:ctor()
  self.uiBinder = nil
  super.ctor(self, "season_achievement_detail_window")
  self.seasonVM_ = Z.VMMgr.GetVM("season")
  self.achievementVM_ = Z.VMMgr.GetVM("achievement")
end

function Season_achievement_detail_windowView:OnActive()
  ...
  self.rightLoopListView_ = LoopScrollRect_.new(self, self.uiBinder.loop_right_item, AchievementListTplItem, "season_achievement_list_tpl", true)
  self.rightLoopListView_:Init({})
  self.allAchievements_ = self.achievementVM_.GetSearchAchievements(Z.DataMgr.Get("season_data").CurSeasonId)
...
function Season_achievement_detail_windowView:OnDeActive()
...
function Season_achievement_detail_windowView:OnDestory()
  Z.UnrealSceneMgr:CloseUnrealScene(self.ViewConfigKey)
end

function Season_achievement_detail_windowView:OnRefresh()
end

function Season_achievement_detail_windowView:GetClassesCount(class)
  local datas = {}
...
function Season_achievement_detail_windowView:GetAchievementIdCount(class, id)
  local count = 0
  if class then
    local datas = {}
    if self.IsInSearch then
...
function Season_achievement_detail_windowView:GetSelectAchievementClass()
  return self.selectAchievementClass_
end

function Season_achievement_detail_windowView:ResetAchievementId()
...
function Season_achievement_detail_windowView:SelectAchievementClass(id)
...
function Season_achievement_detail_windowView:SelectAchievementId(id, needRefreshLoop)
...
function Season_achievement_detail_windowView:refreshList()
  self.leftLoopListView_:RefreshAllShownItem()
  self.rightLoopListView_:RefreshAllShownItem()
end

function Season_achievement_detail_windowView:refreshLoopList()
  local loopData = {}
...
function Season_achievement_detail_windowView:refreshSearchBtn()
  self.uiBinder.Ref:SetVisible(self.uiBinder.btn_clear, self.IsInSearch)
end

function Season_achievement_detail_windowView:getSortClasses()
  local datas = {}
  if self.IsInSearch then
    datas = self.searchAchievements_
  else
...
function Season_achievement_detail_windowView:refreshUI()
  self.selectAchievementClass_ = nil
  self.selectAchievementId_ = nil
...
function Season_achievement_detail_windowView:refreshRightLoopList()
...
function Season_achievement_detail_windowView:refreshTitleUI()
...
return Season_achievement_detail_windowView
