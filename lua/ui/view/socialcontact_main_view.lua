...
local Socialcontact_mainView = class("Socialcontact_mainView", super)
...
function Socialcontact_mainView:ctor()
  self.uiBinder = nil
  super.ctor(self, "socialcontact_main")
...
function Socialcontact_mainView:OnActive()
...
function Socialcontact_mainView:onInitProp()
...
function Socialcontact_mainView:onInitComp()
...
function Socialcontact_mainView:onInitRed()
...
function Socialcontact_mainView:onClickFriendRed()
  Z.RedPointMgr.OnClickRedDot(E.RedType.SocialcontactFriendTab)
end

function Socialcontact_mainView:onClickMailRed()
  Z.RedPointMgr.OnClickRedDot(E.RedType.SocialcontactMailTab)
end

function Socialcontact_mainView:clearRed()
  Z.RedPointMgr.RemoveNodeItem(E.RedType.SocialcontactFriendTab)
  Z.RedPointMgr.RemoveNodeItem(E.RedType.SocialcontactMailTab)
end

function Socialcontact_mainView:OnDeActive()
...
function Socialcontact_mainView:asyncRefreshSelfHead()
  ...
  playerPortraitHgr.InsertNewPortraitBySocialData(self.uiBinder.com_player_portrait_item, socialData)
end

function Socialcontact_mainView:refreshSelfPersonalState()
...
function Socialcontact_mainView:refreshViewShow()
...
function Socialcontact_mainView:onRefreshChat(isShow)
  if isShow then
...
function Socialcontact_mainView:onRefreshFriend(isShow)
  if isShow then
...
function Socialcontact_mainView:onRefreshMail(isShow)
  if isShow then
...
function Socialcontact_mainView:GetCacheData()
  return self.viewData
end

function Socialcontact_mainView:RegisterInputActions()
  Z.InputMgr:AddInputEventDelegate(self.onInputAction_, Z.InputActionEventType.ButtonJustPressed, Z.RewiredActionsConst.Chat)
end

function Socialcontact_mainView:UnRegisterInputActions()
