...
local PersonalZoneMedalCollectEdit = class("PersonalZoneMedalCollectEdit", super)

function PersonalZoneMedalCollectEdit:ctor()
end

function PersonalZoneMedalCollectEdit:OnInit()
...
function PersonalZoneMedalCollectEdit:OnUnInit()
  self.view_ = nil
  self.using_ = nil
end

function PersonalZoneMedalCollectEdit:Refresh()
...
return PersonalZoneMedalCollectEdit
