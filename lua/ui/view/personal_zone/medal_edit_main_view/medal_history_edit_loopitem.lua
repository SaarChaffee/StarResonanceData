...
local PersonalZoneMedalHistoryEdit = class("PersonalZoneMedalHistoryEdit", super)

function PersonalZoneMedalHistoryEdit:ctor()
end

function PersonalZoneMedalHistoryEdit:OnInit()
...
function PersonalZoneMedalHistoryEdit:OnUnInit()
  self.view_ = nil
  self.using_ = nil
end

function PersonalZoneMedalHistoryEdit:Refresh()
...
return PersonalZoneMedalHistoryEdit
