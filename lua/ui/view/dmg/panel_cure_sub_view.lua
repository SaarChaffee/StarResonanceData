...
local Panel_cure_subView = class("Panel_cure_subView", super)
...
function Panel_cure_subView:ctor(parent)
  self.panel = nil
  super.ctor(self, "panel_cure_sub", "dmg/panel_cure_sub", UI.ECacheLv.None)
end

function Panel_cure_subView:initZWidget()
...
function Panel_cure_subView:OnActive()
...
function Panel_cure_subView:OnDeActive()
  Z.EventMgr:RemoveObjAll(self)
end

function Panel_cure_subView:refrehDamagePanel()
  self.damageLoopScrollRect:SetData(dmgData.ShowDamageDatas)
end

function Panel_cure_subView:refrehDevelopmentView()
...
function Panel_cure_subView:refreshTargetDro()
  dmgVm.SetNearMosterTab()
...
function Panel_cure_subView:refreshPartDro()
  self.partScrollRect_:SetData(dmgData.Part)
end

function Panel_cure_subView:BuffSelected(data)
  if data == nil then
    return
  end
  self.bodyLoop_:SetVisible(false)
...
function Panel_cure_subView:AttrSelected(data)
  if data == nil then
    return
  end
  self.targetLoop_:SetVisible(false)
...
function Panel_cure_subView:MonsterSelected(data)
  if data == nil then
    return
  end
  self.partLoop_:SetVisible(false)
...
function Panel_cure_subView:RefreshData()
end

function Panel_cure_subView:OnRefresh()
end

function Panel_cure_subView:BindEvents()
  Z.EventMgr:Add(Z.ConstValue.Damage.RefreshPanel, self.refrehDamagePanel, self)
end

return Panel_cure_subView
