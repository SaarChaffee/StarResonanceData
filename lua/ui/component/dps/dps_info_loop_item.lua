...
local DpsInfoLoopItem = class("DpsInfoLoopItem", super)

function DpsInfoLoopItem:OnInit()
  self.uiView_ = self.parent.UIView
end

function DpsInfoLoopItem:OnReset()
end

function DpsInfoLoopItem:OnRefresh(data)
...
function DpsInfoLoopItem:OnUnInit()
end

return DpsInfoLoopItem
