...
local HomeWarehouseTwoLoopItem = class("HomeWarehouseTwoLoopItem", super)
local itemClass = require("common.item_binder")

function HomeWarehouseTwoLoopItem:OnInit()
...
function HomeWarehouseTwoLoopItem:OnRefresh(data)
...
function HomeWarehouseTwoLoopItem:setCountLab()
  self.itemClass_:SetLab(self.count_)
end

function HomeWarehouseTwoLoopItem:OnPointerClick(go, eventData)
  self.homeEditorVm_.OnClickWareHouseItem(self.data_.configId, self.count_, self.uiView_.IsWarehouse, self.data_.clientUuid)
end

function HomeWarehouseTwoLoopItem:refreshCount(configId)
...
function HomeWarehouseTwoLoopItem:OnRecycle()
...
function HomeWarehouseTwoLoopItem:OnUnInit()
  if self.uiView_.IsWarehouse then
    Z.EventMgr:Remove(Z.ConstValue.Home.RefreshWareHouseCount, self.refreshCount, self)
  end
  self.uiBinder.uisteer:ClearSteerList()
...
return HomeWarehouseTwoLoopItem
