return {
  ...
  ["TestDelegate.TestEventListener_OnClick_Event"] = {Call = 107},
  ["TestDelegate.TestEventListener_VoidDelegate_Event"] = {Call = 108},
  TestEnum = {Test = 312},
  TestEventListener = {
  ...
  TestInstantiate = {Awake = 226, Start = 227},
  TestInstantiate2 = {Awake = 228},
  TestInt64 = {
    OnDestroy = 163,
    OnGUI = 164,
    ShowTips = 162,
  ...
  TestOverload = {Awake = 350, Bind = 351},
  TestPerformance = {
