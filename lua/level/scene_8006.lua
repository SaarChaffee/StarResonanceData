...
function Scene:InitEvents()
  ...
  self.EventItems[7] = {
    ...
    action = function(localSelf)
      ...
      Panda.ZEffect.ZPathEffectMgr.Instance:PlayEffect("Worldevent_Guide_8006", 0, 0, 30, false, 0)
    end
  }
  self.EventItems[8] = {
    eventType = E.LevelEventType.TriggerEvent,
    ...
    action = function(localSelf)
      ...
      Panda.ZEffect.ZPathEffectMgr.Instance:StopEffect("Worldevent_Guide_8006")
    end
  }
end
